...
if discOrDigital == "B":
    ...
    eboot_translator.replace_strings("../eboot-translated-disc.csv","../patch/USRDIR/EBOOT.BIN",ignoreLength=True)
else:
    ...
    shutil.copyfile("../patch/USRDIR/EBOOT.BIN","../patch/USRDIR/EBOOT_BKP.BIN")
    eboot_translator.replace_strings("../eboot-translated-psn.csv","../patch/USRDIR/EBOOT.BIN",ignoreLength=True)
